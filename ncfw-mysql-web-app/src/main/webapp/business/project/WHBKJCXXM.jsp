...
<head>
	...
	function initPage () {
		...
		if(!Ext.isEmpty(pid)) {
			...
			//新建
			Project.generateProjectNum("WHBKJCXXM");
    ...
    <ext:ext onReady="initPage();">
	  	<ext:viewport layout="border" otherProperties="split: true">
	  		...
	  		<ext:tabPanel region="center" border="false" frame="false" otherProperties="activeTab: 0" var="tabPanel">
	  			<ext:items>
  				<ext:panel title="文化部科技创新项目" layout="border" border="false" iconCls="icon_plugin">
  					<ext:items>
	   					<%-- 列表面板 --%>
									...
									<ext:items>
										<ext:fieldSet layout="column" defaults="{columnWidth: 1, layout: 'form'}" lazyInit="true" 
											...
											<ext:html><span style="font-size: 13px;">&nbsp;&nbsp;&nbsp;&nbsp;为确保项目申报规范，准确，请注意以下事项：<br>
													  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1、若申报过程中发现屏幕右侧滚动条无法显示，请调整计算机屏幕分辨率至1024*768或1366*768。<br>      
     	 											  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、首先请填写项目基本信息，项目名称请填写申报项目名称。项目编号由系统自动生成无需填写。承担单位请填写本单位的全称，项目负责人请填写申报项目负责人的姓名全称，联系电话请填写项目负责人的联系电话座机或手机号码。申报部门由系统自动生成无需填写，申报日期为项目申报时的日期。<br>
    												  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3、项目基本信息填写完成后，请下载《文化部科技创新项目开题报告》，<a href="<%=basePath%>business/文化部科技创新项目开题报告.doc" target="blank">点击此处下载</a>。按照开题报告格式及填写要求，进行填写。注意：申请书中所有涉及签字及加盖公章的部分，无需填写。<br>
     												  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4、填写完成后，点击文件上传按钮，在弹出的文件上传界面上，上传填写好的《文化部科技创新项目开题报告》及相关附件，相关附件文件大小不得超过10M 。<br>
     												  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5、流程意见中填写意见一栏可以根据申报项目实际情况填写需提醒资料审核部门注意的事项，也可以选择不填写。最后点击项目申报按钮进行申报。<br>
     												  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;6、在线申报完成后，请将填写好的 《文化部科技创新项目开题报告》打印后，签字并加盖相应公章及相关附件一式三份（其中至少一份为原件）寄送相应资料审核部门。文化部各司局、直属单位、原文化部直属高等艺术院校寄送到文化部科技司，其他单位寄送到所在省、自治区、直辖市文化厅（局）。  </span></ext:html>
										</ext:fieldSet>
										...
										<ext:fieldSet layout="column" defaults="{columnWidth: 1, layout: 'form'}" lazyInit="true" 
											...
											<ext:items>
												...
												<ext:hidden name="project.pmtype" id="pmtype" value="WHBKJCX"></ext:hidden>
