 ...
 * modify-author: Wuqingming
 * modify-date: 2010-12-23
 */
Ext.ns('Ext.ux.grid');
...
AsyncRowExpander = function (config) {
 	AsyncRowExpander.superclass.constructor.call(this, config);
    this.requestFn = config.requestFn || null;
}

Ext.extend(AsyncRowExpander, Ext.grid.RowExpander, {
    onMouseDown : function(e, t) {
