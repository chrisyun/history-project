...
/** 
 * @ClassName: SysLogViewController 
 * @Description: 
 * @author chenyun
 * @date 2012-6-11 下午02:46:54 
 */
public class SysLogViewController extends HttpServlet {
	...
	Logger logger = LoggerFactory.getLogger(SysLogViewController.class);
